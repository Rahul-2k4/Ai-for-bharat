# AI for Bharat 2 Docs Index

This folder tracks the submission package for AI for Bharat 2.
...
- [Decision Log](./decision-log.md): key decisions and why.
- [Team Workflow](./team-workflow.md): shared GitHub collaboration rules for friends.

## Working rule

Keep docs hackathon-specific and submission-focused.
